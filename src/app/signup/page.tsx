...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            // Optional: Redirect to a "verify email" page or stay here
        }
        setLoading(false)
    }
                    ...
                    <div className="mb-12 relative h-[400px] w-full">
                        <div className="w-full h-full relative">
                            <img
                                ...
                                onError={(e) => {
                                    e.currentTarget.src = "https://placehold.co/600x600/E6F9F0/2F855A?text=Join+AI+Tasker";
                                }}
                            />
                        </div>
                    </div>

                    <h2 className="text-3xl font-bold text-[#1F2937] mb-4">Join AI Tasker</h2>
                    <p className="text-gray-600 text-lg mb-8">
                        Create an account to start organizing your life with the power of AI.
                    </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white text-[#1F2937]">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        {message && (
                            <div className={`p-3 rounded-lg text-sm text-center border ${message.includes('Check') ? 'bg-green-50 text-green-600 border-green-100' : 'bg-red-50 text-red-600 border-red-100'}`}>
                                {message}
                            </div>
                        )}
                        ...
                        <div className="text-center pt-4">
                            <p className="text-sm text-gray-500">
                                ...
                                <Link href="/login" className="font-medium text-[#2F855A] hover:underline decoration-1 underline-offset-4">
                                    Sign in
                                </Link>
                            </p>
                        </div>
